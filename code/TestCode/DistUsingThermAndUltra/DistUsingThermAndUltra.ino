...
float GetDistance() {
  ...
  float Time = pulseIn (ECHO_PIN, HIGH);   // This returns the time starting from when the TrigPin went high to when the Echo pin goes high and makes it equal to Time
